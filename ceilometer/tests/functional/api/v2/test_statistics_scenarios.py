...
class BaseAggregates(v2.FunctionalTest):
    PATH = '/meters/instance/statistics'

    def setUp(self):
        super(BaseAggregates, self).setUp()
...
class TestSelectableAggregates(BaseAggregates):
...
@tests_db.run_with('sqlite', 'mysql', 'pgsql', 'mongodb', 'db2', "hbase")
class TestCardinalityAggregates(BaseAggregates):
    def test_per_tenant_selectable_parameterized_aggregate(self):
        ...
        data = self.get_json(self.PATH, groupby=['project_id'],
                             status=[200, 501], **agg_args)
        if "Unable to support cardinality" in data:
    ...
    def test_partially_repeated_parameterized_aggregate(self):
        ...
        data = self.get_json(self.PATH, status=[200, 501],
                             override_params=agg_params)
    ...
    def test_bad_selectable_parameterized_aggregate(self):
        ...
        resp = self.get_json(self.PATH, status=[400, 501],
