...
@tests_db.run_with('sqlite', 'mysql', 'pgsql', 'mongodb', 'db2', "hbase")
...
class StatisticsTest(DBTestBase):
    ...
    def test_by_user_period(self):
        ...
        expected_period_start = set([datetime.datetime(2012, 9, 25, 10, 28),
                                     datetime.datetime(2012, 9, 25, 10, 00),
                                     datetime.datetime(2012, 9, 25, 12, 00),
                                     datetime.datetime(2012, 9, 25, 12, 28)])

        expected_period_end = set([datetime.datetime(2012, 9, 25, 12, 28),
                                   datetime.datetime(2012, 9, 25, 12, 00),
                                   datetime.datetime(2012, 9, 25, 14, 00),
                                   datetime.datetime(2012, 9, 25, 14, 28)])

        for r in results:
            self.assertIn(r.period_end, expected_period_end)
            self.assertIn(r.period_start, expected_period_start)
    ...
    def test_by_user_period_with_timezone(self):
        ...
        for date in dates:
            ...
            expected_period_start = set(
                [datetime.datetime(2012, 9, 25, 10, 28),
                 datetime.datetime(2012, 9, 25, 10, 00),
                 datetime.datetime(2012, 9, 25, 12, 00),
                 datetime.datetime(2012, 9, 25, 12, 28)])

            expected_period_end = set(
                [datetime.datetime(2012, 9, 25, 12, 28),
                 datetime.datetime(2012, 9, 25, 12, 00),
                 datetime.datetime(2012, 9, 25, 14, 00),
                 datetime.datetime(2012, 9, 25, 14, 28)])
