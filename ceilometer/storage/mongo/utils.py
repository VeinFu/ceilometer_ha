...
def make_timestamp_range(start, end, start_timestamp_op=None,
                         end_timestamp_op=None, resource=False):
    ...
    if start:
        ...
        if resource:
            ts_range["last_sample_timestamp"] = {start_timestamp_op: start}
        else:
    ...
    if end:
        if end_timestamp_op == 'le':
            ...
            end_timestamp_op = '$lt'
        if resource:
            ts_range["first_sample_timestamp"] = {end_timestamp_op: end}
        else:
