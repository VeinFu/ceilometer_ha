...
API_OPTS = [
    ...
    cfg.IntOpt('request_socket_timeout',
               min=0,
               default=600,
               help='Default timeout for werkzeug sockets.'),
]
...
class WSGIRequestHandlerWithTimeout(serving.WSGIRequestHandler):
    def __init__(self, request, client_address, server):
        self.timeout = cfg.CONF.api.request_socket_timeout
        super(WSGIRequestHandlerWithTimeout, self).__init__(request,
                                                            client_address,
                                                            server)
...
def build_server():
    ...
    serving.run_simple(cfg.CONF.api.host, cfg.CONF.api.port,
                       ...
                       request_handler=WSGIRequestHandlerWithTimeout)
